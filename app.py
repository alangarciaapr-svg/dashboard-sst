...
with tab_dash:
    ...
    if row['Medidas Correctivas Abiertas'] == 0: p_medidas = 100
    else: p_medidas = safe_div(row['Medidas Correctivas Cerradas'], row['Medidas Correctivas Abiertas'])
    ...
    # --- AQUÍ ESTABA EL ERROR: AGREGUÉ 'key=title' PARA QUE NO SE DUPLIQUE EL ID ---
    def donut(val, title):
        ...
        # La solución es agregar key=title aquí abajo:
